...
Soy **Técnico Superior en Automatización y Robótica**, con una profunda especialización en **Inteligencia Artificial, Big Data y Desarrollo Web**. Mi perfil nace de la fusión entre el mundo industrial y la programación, permitiéndome abordar problemas desde múltiples ángulos.

- 🔭 Actualmente trabajo como **Analista de Proyectos** enfocado en el desarrollo de soluciones, análisis de datos y automatización.
- 🎓 Tengo la fortuna de mezclar formación mecánica con robótica industrial, y especializarme en la actualidad en tecnologías del Dato e IA.
- 🌱 Siempre aprendiendo y creando side-projects atractivos (desde minijuegos hasta automatizaciones y bots).
- 📫 Puedes escribirme a: **juanjomolinalopez234@gmail.com**
...
- 👾 **[Web Tarariketevi](https://web-tararik.vercel.app/)** - Desarrollo de página web para un negocio local con estilo de neones y futurista.
